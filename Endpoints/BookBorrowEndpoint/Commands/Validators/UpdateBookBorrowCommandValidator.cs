...
{
    public sealed class UpdateBookBorrowCommandValidator : AbstractValidator<UpdateBookBorrowCommand>
    {
        private readonly ApiDbContext _dbContext;

        public UpdateBookBorrowCommandValidator(ApiDbContext dbContext)
        {
